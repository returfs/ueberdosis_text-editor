...
export const TextMenu = ({ editor }: TextMenuProps) => {
  ...
  return (
    <BubbleMenu
      ...
      updateDelay={100}
    >
      <Surface className="inline-flex h-full flex-row items-center gap-1 p-1 leading-none">
        ...
        <MemoButton size="icon" onClick={commands.onCodeBlock}>
        ...
        <Popover>
          <PopoverTrigger asChild>
            <MemoButton size="icon" isActive={!!states.currentHighlight}>
        ...
        <Popover>
          <PopoverTrigger asChild>
            <MemoButton size="icon" isActive={!!states.currentColor}>
